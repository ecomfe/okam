...
<switch name="switch1" type="checkbox" bindchange="__handlerProxy" checked="{{switchVal}}" data-okam-model-args="switchVal,value"></switch>
<model-component bindchange="__handlerProxy" value="{{componentVal}}" data-okam-model-args="componentVal"/>
<sp-model-component bindspchange="__handlerProxy" spvalue="{{componentVal}}" data-okam-model-args="componentVal,valuewx"/>
