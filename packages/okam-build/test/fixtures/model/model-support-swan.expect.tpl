...
<switch name="switch1" type="checkbox" bindchange="__handlerProxy" checked="{{switchVal}}" data-model-args="switchVal,checked"></switch>
<model-component bindchange="__handlerProxy" value="{{componentVal}}" data-model-args="componentVal,value"/>
<sp-model-component bindspchange="__handlerProxy" spvalue="{{componentVal}}" data-model-args="componentVal,valueswan"/>
